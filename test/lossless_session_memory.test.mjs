...
for (const required of ['crag_session_search', 'crag_session_describe', 'crag_session_expand', 'crag_session_export', 'crag_recall', 'crag_explain_memory', 'crag_corpus_ingest', 'crag_corpus_search', 'crag_corpus_describe', 'crag_large_describe', 'crag_large_search', 'crag_large_excerpt']) {
